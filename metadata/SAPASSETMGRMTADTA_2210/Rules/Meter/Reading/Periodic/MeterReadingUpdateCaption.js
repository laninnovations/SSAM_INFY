    ...
    if (pageProxy.binding.FromSingleRegister) {
        ...
        try {
            ...
            if (pageProxy.binding.Device_Nav) {
                ...
                registers = pageProxy.count('/SAPAssetManager/Services/AssetManager.service', pageProxy.binding.Device_Nav['@odata.readLink'] + '/PeriodicMeterReading_Nav', '$filter=sap.islocal()');
                ...
                // If page has not been set up yet, this will be called
                registers = pageProxy.count('/SAPAssetManager/Services/AssetManager.service', pageProxy.binding.DeviceLink['@odata.readLink'] + '/PeriodicMeterReading_Nav', '$filter=sap.islocal()');
